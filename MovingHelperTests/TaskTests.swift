...
class TaskTests: XCTestCase {
  ...
  fileprivate func checkDeserializationForTaskProperties(_ title: String,
    dueDate: TaskDueDate,
    taskID: Int,
    notes: String?,
    done: Bool) {
      ...
      let testTaskDict = [
        ...
        TaskJSONKey.Notes.rawValue: notes ?? "",
  ...
  func testTaskJSONSerialization() {
    ...
    if let retrievedNotes: AnyObject =  jsonDict.value(forKey: TaskJSONKey.Notes.rawValue) as AnyObject? {
